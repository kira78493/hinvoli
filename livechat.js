...

{
    ...
    var MOBILE_URL = 'http://www.globalso.site/php/app.php?widget-mobile';
	MOBILE_URL = MOBILE_URL.replace('https://','//');
	MOBILE_URL = MOBILE_URL.replace('http://','//');
    ...
    var inline = false,
        ...
        src    = 'http://www.globalso.site/php/app.php?widget-iframe-content';
...

    {
...

        {
            ...
            iframe.style.bottom       = -(405 - HEADER_HEIGHT) + 'px';

            iframe.style[WIDGET_SIDE] = '12px';
        ...
        iframe.style.width      = inline ? '100%' : '337px';

        iframe.style.height     = inline ? '100%' : '405px';
