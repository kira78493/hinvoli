        ...
        e.setup({
            ...
            onready: function() {
               ...
               /* s.addSounds({
                ...
                }), */t.length > 0) for (var n = 0; n < t.length; n++) s.addSounds(t[n]);
...
function(t, e) {
    ...
    i.prototype = {
        ...
        send: function(t, e, i) {
            e._t = Date.now();
            var s = t.indexOf("?") !== -1 ? "&": "?";
            if (e) for (var n in e) t += s + n + "=" + encodeURIComponent(e[n]),
            "?" === s && (s = "&");
            var o = new Image;
    ...
    },
    {
        ...
        addShortUrl: function(t) {
            ...
            if (e) {
                var i = e.split("/");
                i.splice(0, 2),
                i.length > 2 ? t.shortUrl = i[0] + "/../" + i.pop() : t.shortUrl = i[0] + "/" + i.pop()
            } else t.shortUrl = ""
        },
    ...
    var i = t.MessageModel = Backbone.Model.extend({
        ...
        initialize: function(e, s) {
            ...
            e) {
                ...
                if (e.extra && e.extra.type === i.EXTRA_FILES) if (e.upload) {
                    var l = t.model.watchedUploads.get(e.upload.id);
                    l ? this.upload = l: this.upload = new t.UploadModel(e.upload),
...
function(t, e, i, s) {
    var n = t.GuestChatModel = Backbone.Model.extend({
        ...
        loadDepartments: function(t) {
            var n = this;
            e.get(i.onlineDepartmentsPath,
            function(t) { ! t.departments || 0 !== t.departments.length && s.pluck(t.departments, "status").indexOf("online") === -1 || (n.departments = t.departments, n.trigger("departments:change"))
            })
        },
        ...
        getTypingStatus: function(t) {
            var s = this,
            n = e.post(i.getTypingStatusPath,
            function(t) {
        ...
        onMessages: function(e) {
            var i = this;
            e.length > 0 && (this.removeReadMessages(e), this.storeMessages(e), this.loadOperatorsData(e,
            function() {
                for (var s = 0; s < e.length; s++) {
                    var n = e[s];
                    n.from_id > 0 && t.UserModel.getUser(n.from_id,
                    function(t) {
        ...
        onUploads: function(e) {
            e = s.values(e),
            e.length > 0 && t.model.watchedUploads.set(e, {
                remove: !1
            })
        },
        storeMessages: function(t) {
            s.each(t,
            function(t) { ! t.datetime && t.time && (t.datetime = t.time.getTime()),
                t.id && t.id > this.lastMessageId && (this.lastMessageId = t.id)
            },
            this),
        ...
        loadOperatorsData: function(e, i) {
            ...
            return 0 === s.length ? void i() : void t.UserModel.getUsers(s,
            function(t) {
                i()
            })
        },
        ...
        sendMessage: function(t, s) {
            ...
            o = this;
            e.post(i.sendMessagePath, n,
            function(e) {
                e.success ? (t.set("id", parseInt(e.id)), o.storeMessages([t.attributes]), o.trigger("messages:sent")) : o.trigger("messages:sendError"),
                s && s(e)
            })
        },
        isChatting: function() {
        ...
        startConnection: function() {
            ...
            this.connectionTimer = setInterval(e.proxy(this.manageConnection, this), n.POLLING_INTERVAL),
        ...
        _manageConnection: function(s) {
            ...
            t.service.geoloc.empty || (i.info.geoloc = t.service.geoloc.info, o.info = JSON.stringify(i.info), t.service.geoloc.empty = !0),
            t.model.watchedUploads.length > 0 && (o.watchedUploads = t.model.watchedUploads.pluck("id").join(","));
            var a = e.post(i.manageConnectionPath, o,
            function(t) {
                n.onUser(t.user),
                t.lastMessageId && t.lastMessageId > this.lastMessageId && (this.lastMessageId = t.lastMessageId),
        ...
        prevRequestsComplete: function() {
            if (Date.now() - this.requestInitTime > n.REQUEST_STATUS_RESET_TIMEOUT) return this.initRequestsStatus(),
            !0;
            for (var t in this.requestsStatus) if (!this.requestsStatus[t]) return ! 1;
            return this.requestInitTime = Date.now(),
            !0
        },
        ...
        manageTracking: function() {
            var s = {};
            s.url = i.info.referer,
            t.service.beacon.send(i.trackKeepAlivePath, s, e.proxy(this.onTrackingResponse, this))
        },
    ...
    var i = Backbone.Collection.extend({
        ...
        removeUnused: function() {
            for (var t = this.models.length - 1; t >= 0; t--) {
                var e = this.models[t]; (e.isSettled() || e.isUnused()) && this.remove(e)
            }
        }
    });
...
function(t, e, i) {
    t.LoginFormView = Backbone.View.extend({
        ...
        reset: function() {
            ...
            e && 0 !== e.length ? this.$departmentsBtn.parent().show() : this.$departmentsBtn.parent().hide(),
            this.$name.val(""),
            this.$mail.val(""),
            this.$name.removeClass("customer-chat-input-error"),
            this.$mail.removeClass("customer-chat-input-error"),
            "true" !== i.ui.askForMail && this.$mail.hide().val(t.service.i18n.trans("empty.mail.placeholder"))
        },
...
function(t, e) {
    t.ContactFormView = Backbone.View.extend({
        ...
        initialize: function() {
            ...
            this.$name.on("input change keydown blur", e.proxy(this.validateName, this)),
            this.$mail.on("input change keydown blur", e.proxy(this.validateMail, this)),
            this.$message.on("input change keydown blur", e.proxy(this.validateMessage, this))
        },
        reset: function() {
            this.$name.val(""),
            this.$mail.val(""),
        ...
        isValid: function() {
            ...
            this.nameValid && this.mailValid && this.messageValid
        },
        getHeight: function() {
            return this.$form.height()
        }
...
function(t, e, i) {
    var s = t.AvatarView = Backbone.View.extend({
        ...
        render: function() {
            ...
            } else this.$el.removeClass("customer-chat-content-message-avatar").addClass("customer-chat-content-message-avatar-operator"),
            this.model.fromUser && this.model.fromUser.image && this.$el.css("background-image", 'url("' + this.model.fromUser.image + '")')
        }
    },
    {
        INFO: {
...
function(t, e, i) {
    ...
    r = t.MessageView = Backbone.View.extend({
        initialize: function() {
            this.subviews = [],
            this.options.prevMessage && (this.prevMessage = this.options.prevMessage, this.model.get("from_id") == this.prevMessage.get("from_id") && (this["short"] = !0)),
        ...
        render: function() {
            ...
            this.updateTime(!0),
            this["short"] && !this.model.isSystemMessage() ? (this.$el.addClass("short"), this.prevMessage.getAge() - this.model.getAge() < r.VISIBLE_AGE_LIMIT && this.$time.hide()) : new t.AvatarView({
                el: this.$(".avatar")[0],
                model: this.model
            })
        },
        buildBody: function(i) {
            ...
            for (var o, a = this.settings.get("emots"), l = this.model.get("body").split("<").join("&lt;").split(">").join("&gt;"), h = "off" !== e.ui.chatBoxMedia; o = s.exec(l);) {
                ...
                u = o[0],
                m = !0;
                if (l = l.slice(d + u.length), c.length > 0 && i.append(a ? r.addEmoticons(c) : c), h) if (r.isImageLink(u)) i.append(this.storeSubview(r.createImageView(u))),
                m = !1;
                else {
                    var g; (g = r.isYouTubeLink(u)) ? (i.append(this.storeSubview(r.createVideoView("youtube", u, g))), m = !1) : (g = r.isVimeoLink(u)) && (i.append(this.storeSubview(r.createVideoView("vimeo", u, g))), m = !1)
                }
...
function(t, e, i) {
    t.MessageImageView = Backbone.View.extend({
        ...
        render: function() {
            ...
            this.settings.get("media") ? "auto" === e.ui.chatBoxMedia ? this.showContent() : (this.manualShow = !0, this.$el.addClass("manual-show")) : this.$el.addClass("chat-inline-disabled"),
            this
        },
...
function(t, e, i) {
    var s = t.MessageFileView = Marionette.ItemView.extend({
        ...
        templateHelpers: {
            ...
            fileIcon: function() {
                if (this.type) for (var t in s.mimeToIcon) if (this.type.indexOf(t) > -1) return s.mimeToIcon[t];
                return "file-o"
            },
            state: function() {
        ...
        initialize: function(e) {
            ...
            this.message.uploader && (this.uploader = this.message.uploader, _.bindAll(this, "onError", "onAbort", "onLoad", "onProgress"), this.uploader.on("error", this.onError), this.uploader.on("abort", this.onAbort), this.uploader.on("load", this.onLoad)),
        ...
        render: function() {
            ...
            if (e === t.UploadModel.STATE_ERROR || e === t.UploadModel.STATE_UPLOADED || this.upload.previous("state") !== t.UploadModel.STATE_UPLOADED) {
                ...
                this.$el.attr("class", "file-message").addClass(e ? e: "initial"),
                s ? this.$el.addClass("operator") : n || this.$el.addClass("no-actions"),
                this.bindUIElements(),
                e === t.UploadModel.STATE_UPLOADED && i && this.setDownloadLinks(_.pluck(i, "id")),
...
function(t, e) {
    t.ChatBoxView = Backbone.View.extend({
        ...
        addMessage: function(e, i, s) {
            ...
            this.messageViews.push(o),
            this.$wrapper.append(o.el);
            var a = this;
            return setTimeout(function() {
                a.updateScroller(),
                s ? i && a.$el.mCustomScrollbar("scrollTo", "bottom") : (a.settings.get("scroll") || i) && a.$el.mCustomScrollbar("scrollTo", "bottom")
            },
            200),
            o
        },
...
function(t, e, i) {
    var s = Marionette.Object.extend({
        ...
        run: function() {
            ...
            return "undefined" != typeof l ? (s.upload.set("error", l), s.upload.set("state", t.UploadModel.STATE_ERROR)) : this.chat.sendMessage(s,
            function(t) {
...
function(t, e, i) {
    t.FileDropZoneView = Marionette.ItemView.extend({
        ...
        enableEffect: function(t) {
            t.preventDefault(),
            t.stopPropagation(),
            this._isFileTransfer(t) && (this.disableTimer && clearTimeout(this.disableTimer), this.$el.addClass("active"))
        },
...
function(t, e, i) {
    var s = t.WidgetView = Backbone.View.extend({
        ...
        initialize: function() {
            ...
            "true" == i.ui.fileSharing ? (this.fileDropZone = new t.FileDropZoneView({
                el: this.$(".file-drop-zone")
            }), this.fileDropZone.on("drop", this.onFilesDrop, this)) : this.$fileBtn.hide(),
            this.showLoading(),
            this.model.once("operators:online",
            function() {
                this.postMessage("show"),
                this.initialized = !0
            },
            this),
            this.model.once("operators:offline",
            function() {
            ...
            ("true" === i.ui.autoShowWidget || "off" !== i.ui.autoShowWidget && this.settings.get("autoShow")) && (this.autoShowTimer = setTimeout(e.proxy(this.show, this), 1e3 * i.ui.autoShowWidgetAfter)),
            setInterval(e.proxy(this.chatBox.updateScroller, this.chatBox), 1500)
        },
        setState: function(e) {
            if (this.state != e) {
                ...
                case "mailTranscript":
                    ...
                    this.$title.html(t.service.i18n.trans("mailTranscriptHeader"));
                    var o = this.model.get("mail");
                    o && o !== t.service.i18n.trans("empty.mail.placeholder") ? this.mailTranscript.reset(o) : this.mailTranscript.reset(),
                    this.mailTranscript.focus();
                    break;
                case "endTalk":
                    this.$el.addClass("chat-box end-talk"),
                    /*this.$title.html(t.service.i18n.trans("chatHeader")),*/
                      this.$title.html('Get Detailed Prices'),
                    this.prevState = e;
                    break;
                case "login":
        ...
        show: function() {
            ...
            this.autoShowTimer && (clearTimeout(this.autoShowTimer), delete this.autoShowTimer),
            this.$el.addClass("customer-chat-visible"),
            this.stopTitleBlink(),
            this.prevFullscreen && this.fullscreenOn(),
            this.postMessage("animate|bottom=0"),
            this.postMessage("css|z-index=1000000")
        },
        hide: function(t) {
            var s = t ? "css": "animate";
            this.visible = !1,
            this.prevFullscreen = this.fullscreen,
            "untilAction" === i.ui.autoShowWidget && this.settings.set("autoShow", !1),
            this.fullscreen ? (this.postMessage(s + "|bottom=" + (this.headerHeight - (this.contentHeight || this.frameHeight)) + "px"), this.fullscreenOff()) : this.storeProperties(e.proxy(function() {
            ...
            this.$settings.hide(),
            this.$emoticons.hide(),
            this.postMessage("css|z-index=999998")
        },
        toggle: function(t) {
        ...
        handleMessages: function(i) {
            ...
            n && this.shouldNotifyAbout(i) && (this.settings.get("sound") && t.service.soundPlayer.play(o ? "systemMessage": "message"), this.visible || (this.settings.get("show") ? this.toggle() : this.startTitleBlink()), this.$mobileTitle.is(":visible") && (this.stopTitleBlink(), this.startTitleBlink()), setTimeout(e.proxy(this.stopTypingInfoBlink, this), 1))
        },
        ...
        inputBlur: function() {
            var t = this;
            setTimeout(function() {
                t.$el.removeClass("input-focused"),
                t.chatBox.updateScroller()
            },
            100)
        },
        ...
        handleOperatorTyping: function() {
            ...
            this.stopTypingBlinkTimer && clearTimeout(this.stopTypingBlinkTimer),
            this.stopTypingBlinkTimer = setTimeout(e.proxy(this.stopTypingInfoBlink, this), s.TYPING_STATUS_TIME)
        },
        sendContactMessage: function() {
            if (this.contactForm.isValid()) {
                ...
                n = this;
                e.post(i.contactPath, s,
                function(e) {
		            e.success ? (n.contactForm.reset(), n.showInfo(t.service.i18n.trans("contactSuccessMessage"), t.service.i18n.trans("contactSuccessHeader")),$('body').append(e.google_js)) : n.showInfo(t.service.i18n.trans("contactErrorMessage"), t.service.i18n.trans("contactErrorHeader"))
                }),
                this.showLoading()
            }
        },
        startTitleBlink: function() {
            this.titleBlinking = !0,
            this.blinkTitle()
        },
        blinkTitle: function() {
        ...
        blinkTypingInfo: function() {
            if (this.typingInfoBlinking) {
                var t = this;
                this.$typingInfo.fadeIn("slow",
                function() {
                    t.$typingInfo.fadeOut("slow",
                    function() {
                        t.blinkTypingInfo()
                    })
                })
        ...
        storeProperties: function(t) {
            if (!i.mobile && !i.inline && !this.fullscreen) {
                ...
                var e = this;
                this.postMessage("get.properties",
                function(i) {
                    var s = i.split(",");
        ...
        updateSize: function() {
            setTimeout(e.proxy(function() {
                var t;
                "login" === this.state ? t = this.loginForm.getHeight() + this.$header.height() : "contact" === this.state ? t = this.contactForm.getHeight() + this.$header.height() : "chat" === this.state && (t = this.frameHeight),
                t && (this.contentHeight = Math.max(this.frameHeight, t), this.storeProperties(e.proxy(function() {
                    this.visible || this.postMessage("css|bottom=" + (this.headerHeight - (this.contentHeight || this.frameHeight)) + "px"),
...
function(t, e, i) {
    t.SelectListView = Backbone.View.extend({
        ...
        initialize: function() {
            ...
            this.options.readOnly && (this.$el.addClass("read-only"), setTimeout(i.proxy(this.undelegateEvents, this), 0));
            var s = this;
        ...
        render: function() {
            ...
            0 === e.length ? this.$el.addClass("empty") : this.$el.removeClass("empty"),
            ...
            return this.options.noScroll || this.$el.find(".entries").mCustomScrollbar(),
            this
        },
        toggleEntry: function(t) {
            ...
            if (!e.hasClass("disabled")) {
                ...
                o = e.find(".fa");
                this.options.single ? (this.selectNone(!0), this.selected = [s], this.styleItem(e, o, !0)) : n !== -1 ? (this.selected.splice(n, 1), this.styleItem(e, o, !1)) : (this.selected.push(s), this.styleItem(e, o, !0)),
                this.trigger("updateSelection")
            }
        },
        select: function(t) {
            0 === t.length && this.options.selectedOnly && this.$el.addClass("empty"),
            this.selected = [];
            var e = this;
...
function(t, e, i) {
    t.SelectAvatarInlineView = Backbone.View.extend({
        ...
        prev: function() {
            this.selectedIndex--,
            this.selectedIndex < 0 && (this.selectedIndex = this.model.length - 1),
            this.updateAvatar()
        },
        next: function() {
            this.selectedIndex++,
...
function(t, e, i) {
    t.WidgetFacade = function() {
        ...
        n.once("operators:online",
        function() {
            this.trigger("operators:online")
        },
        this).once("operators:offline",
        function() {
            this.trigger("operators:offline")
        },
        this).on("messages:new",
        function() {
        ...
        this).on("logout:success",
        function() {
            this.trigger("logout:success")
        },
        this).on("operator:typing",
        function() {
